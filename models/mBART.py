...
class mBART(nn.Module):
    ...
    def __init__(self, criterion, tokenizer, max_length = article_length, min_length = 50, MODEL = 'Helsinki-NLP/opus-mt-en-fr'):
    ...
    def generate(self, input_ids, num_beams = 2):
        ...
        # # beam search
        # summary_ids = self.mbart_model.generate( input_ids = input_ids, num_beams = num_beams, max_length = self.max_length, no_repeat_ngram_size = 2, repetition_penalty = 1.2)

        # # beam search
        # summary_ids = self.mbart_model.generate( input_ids = input_ids, num_beams = num_beams, early_stopping = True, max_length = self.max_length, no_repeat_ngram_size = 2, repetition_penalty = 1.2)
