...
class TRANSFORMER_MODEL(nn.Module):
    def __init__(self,criterion,rnn_tokenizer):
        super(TRANSFORMER_MODEL, self).__init__()
        SRC_VOCAB_SIZE = rnn_tokenizer.get_vocab_size()
        TGT_VOCAB_SIZE = rnn_tokenizer.get_vocab_size()
        self.MAX_LENGTH = 50
        self.PAD_IDX = rnn_tokenizer.token_to_id('<pad>')
        self.BOS_IDX = rnn_tokenizer.token_to_id('<bos>')
        self.EOS_IDX = rnn_tokenizer.token_to_id('<eos>')
        self.vocab_size = rnn_tokenizer.get_vocab_size()
