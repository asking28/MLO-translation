...
class TRANSFORMER_MODEL(nn.Module):
    def __init__(self,criterion,rnn_tokenizer,max_length=128,MODEL=None):
        super(TRANSFORMER_MODEL, self).__init__()
        SRC_VOCAB_SIZE = rnn_tokenizer.vocab_size+1
        TGT_VOCAB_SIZE = rnn_tokenizer.vocab_size+1
        self.MAX_LENGTH = max_length
        self.PAD_IDX = rnn_tokenizer.pad_token_id
        self.BOS_IDX = rnn_tokenizer.bos_token_id
        self.EOS_IDX = rnn_tokenizer.eos_token_id
        self.vocab_size = rnn_tokenizer.vocab_size+1
